        ...
        $$('[name$=\[month\]]').each(function(monthElement) {
            ...
            var dateTimeCheck = function() {
                ...
                if (monthElement.value != "" || dayElement.value != "" || yearElement.value != "") {
                    ...
                    } else if ((isNaN(day) || day < 1)  && (document.activeElement!=monthElement && document.activeElement != dayElement)) {
                ...
                $A(cond.action).each(function(action) {
                    if((visibility === "showmultiple" || visibility === "hidemultiple") && action.fields) {
                        ...
                        action.fields.each(function(multiField) {
                            if(multiField === field && action.visibility.toLowerCase() === visibility && action.hasOwnProperty('currentlyTrue') && action.currentlyTrue) {
